...
const App = () => {
  ...
  const editionDrop = useEditionDrop("0xD6EC586beE9A22E5F1B5Df0ac3077EE624568ba2");

  const token = useToken("0xe952512456B095E3e449E6Ce6d9BA8189Ae45F48");

  const vote = useVote("0xbcD6f4b06FF11CEC04E112D82a4Cad06aaA7fa6e");
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Salve! Bem-vindos à SidelabDAO</h1>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>🚀 Página dos membros da SidelabDAO</h1>
        <p>Parabéns por fazer parte desse clube de estudos de web 3.0!</p>
        <div>
          <div>
  ...
  return (
    <div className="mint-nft">
      <h1>Cunhe gratuitamente seu NFT de membro 🚀 da SidelabDAO</h1>
      <button
        disabled={isClaiming}
        onClick={mintNft}
      >
